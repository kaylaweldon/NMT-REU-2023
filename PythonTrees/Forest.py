...
class Forest:
    ...
    def anonymize_forest_brute_force_recursion(self, editDistanceMatrix, complexityCounter):
        ...
        if len(editDistanceMatrix) == 1:
            ...
            return [[editDistanceMatrix[0][1][1][0], editDistanceMatrix[0][1][1][0]], editDistanceMatrix[0][1][1][1], complexityCounter]
        ...
        for optionIndexChosen in range(1, len(editDistanceMatrix[0])):
            ...
            if len(alteredEditDistanceMatrix) > 0:
                ...
                optimalAlteredPairings = self.anonymize_forest_brute_force_recursion(alteredEditDistanceMatrix, complexityCounter)
    ...
    def deal_with_leftovers(self, distancesAndTrees):
        ...
        # consider what the total would be for each possible matching
        for potential_match_index in range(1 , len(distancesAndTrees[0])):
    ...
    # OLD method that does NOT return the optimal answer. It only considers matches
    # which have the smallest edit distance, but this is not sufficient. The newer 
    # deal with leftovers method checks all combinations, which is needed.
    # i came up with an example where this OLD method does not work. Now it does. 
    def deal_with_leftovers_OLD(self, distancesAndTrees):
    ...
    def main(self):
        ...
        self.forest = [['hotels & travel', ['travel services', ['travel agents']], ['rv parks'], ['bed & breakfast'], 
            ['hotels'], ['airports']],
        ...
        print("TESTIN NEW LEFTOVER METHOD")
        print(self.leastUpperBound(trippyExT1, trippyExT2)) 
        #
        # THERE IS A DIFFERENCE!
        # 
        # old leftover method returned:
        #   [['x', ['x', ['x', ['t1111'], ['x', ['t2211'], ['t22112']]]], ['t21', ['t21', ['t211', ['t2111']], ['t212', ['t2121', ['t21211', ['t212111',        ['t2121111']]]]]], ['t212']]], 11]
        #
        # TESTIN NEW LEFTOVER METHOD: returned
        #   [['x', ['x', ['x', ['t211', ['t2111']], ['x', ['t2121', ['t21211', ['t212111', ['t2121111']]]]]], ['t212']], ['t22', ['t22', ['t221', ['t2211'], ['t22112']]]]], 9]
